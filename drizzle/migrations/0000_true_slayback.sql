...
CREATE UNIQUE INDEX `lobby_participants_lobby_user_idx` ON `lobby_participants` (`lobby_id`,`user_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `match_participants_match_user_idx` ON `match_participants` (`match_id`,`user_id`);